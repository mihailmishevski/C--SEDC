...
people.Where(x => x.FirstName[0] == 'R').OrderByDescending(x => x.Age).ToList().ForEach(x => Console.WriteLine(x.FirstName));
Console.WriteLine("=======");
dogs.Where(x => x.Color == "Brown" && x.Age > 3).OrderBy(x => x.Age).ToList().ForEach(x => Console.WriteLine(x.Name));
Console.WriteLine("=======");
people.Where(x => x.Dogs.Count > 2).OrderByDescending(x => x.FirstName).ToList().ForEach(x => Console.WriteLine(x.FirstName));
Console.WriteLine("=======");
people.Where(x => x.FirstName == "Freddy").ToList().ForEach(x => x.Dogs.Where(x => x.Age > 1).ToList().ForEach(x => Console.WriteLine(x.Name)));
Console.WriteLine("=======");
Console.WriteLine(people.Find(x => x.FirstName == "Nathen").Dogs.First().Name);
Console.WriteLine("=======");
people.FindAll(x => x.FirstName == "Cristofer" || x.FirstName == "Freddy" || x.FirstName == "Erin" || x.FirstName == "Amelia").ForEach(x => x.Dogs.Where(x => x.Color == "White").ToList().ForEach(x => Console.WriteLine(x.Name)));